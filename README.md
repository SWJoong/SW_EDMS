...
아주 빠르고 그럴싸하게 제작해주더랍니다. 샘플 데이터부터 작동 로직까지 당장 써도 큰 무리가 없어보일 정도였습니다.  

대신 사람이란 게 욕심이 많아지다 보니 이것도, 저것도 추가하고 싶어지겠지요?  
아이디어도 샘이 솟아 우리 기관에 필요하다고 느꼈던 수많은 프로그램이 생각나기 시작할 겁니다.  
그런 와중에도 우리가 신경써야 할 것들이 많습니다.  
배포, 보안, DB 관리, 인공지능 추가 시 발생하는 API 비용, 도메인 유지 비용, 사용자 테스트와 오류 수정 등을 거쳐야 하기 때문입니다.  
...
그 시간이 당사자를 이해하는 데 조금이나마 도움이 되었다면 우리가 바이브코딩을 공부하고 시도한 게  
그 순간만큼은 헛되거나 본말전도된 게 아니라고 생각해보는 중입니다. ^^    
